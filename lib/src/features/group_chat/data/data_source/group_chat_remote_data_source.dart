...
//   //   try {
//   //      print("GENERATING BALLOTS NUMBERS");
//   //      final result = await client.post(Uri.parse(""),body: json.encode({"groupId":groupId}),headers: {"content-type":"application/json"});
//   //      if(result.statusCode==200) return true;
//   //      return false;
//   //   } on ServerExceptions {
//   //      throw Left(ServerFailure("Failure"));
//   //   }
//   // }
