...
//   //     try {
//   //       print("BALLOT EVENT");
//   //       final result = await groupChatUsecase.generateBallots(groupId: event.groupId);
//   //       result.fold((l)=>emit(GroupChatError(error: "Error")), (data)=>emit(GroupBallotsGenerated()));
