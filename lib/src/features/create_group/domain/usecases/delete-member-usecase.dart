...
class DeleteGroupMembernUsecase {
 final GroupRepository groupRepository;

 DeleteGroupMembernUsecase({required this.groupRepository});

  Future<Either<Failure,void>> call(String groupId)async{
    try {
     final result = await groupRepository.deleteMembers(groupId: groupId);
     return Right(result);
    } on Failure {
